...
- Double-click `cmunrm.ttf` and `install` the font.
- You are ready to go :heart_eyes:. The `CMU serif` font can be selected among all the fonts available in your system.